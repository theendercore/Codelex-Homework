    ...
    <div>
      ...
      >
        <input
          ...
          className="m-2 rounded border-0 bg-yellow-300 p-2 focus:ring-white"
          value={task.title}
        ...
        {task.title.length > 0 && (
          <>
            ...
            />
            <button className="w-max self-center rounded-xl bg-yellow-700 p-2 text-xl hover:bg-yellow-600">
              <svg
